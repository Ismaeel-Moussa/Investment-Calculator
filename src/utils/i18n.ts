...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    footerTitle: 'Investment Calculator • Built with React, TypeScript & Vite',
    footerSubtitle: 'Zero-config deploy ready for Vercel & Netlify • PWA Enabled',
  ...
  ar: {
    ...
    footerTitle: 'حاسبة الاستثمار التراكمي • مصممة بأحدث تقنيات الويب React & TypeScript',
    footerSubtitle: 'جاهزة للعمل دون اتصال بالإنترنت • تدعم التثبيت كتطبيق PWA',
